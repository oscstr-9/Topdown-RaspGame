...
IMGUI_API int       ImGui_Marmalade_PointerButtonEventCallback(void* SystemData, void* pUserData);
IMGUI_API int       ImGui_Marmalade_KeyCallback(void* SystemData, void* userData);
IMGUI_API int       ImGui_Marmalade_CharCallback(void* SystemData, void* userData);
